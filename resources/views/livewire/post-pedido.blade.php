                                ...
                                <div class="col-sm-8">
                                    <div class="row" style="display: flex; justify-content: flex-end;">
                                        <div class="col-xs-5 col-sm-5 col-md-4 col-lg-4">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input wire:model="fecha" type="date" class="form-control float-right"
                                                        id="fecPrincipal">
                                                </div>
                                                <!-- /.input group -->
                                            </div>
                                        ...
                                        <div class="col-xs-4 col-sm-3 col-md-1 col-lg-1">
                                            <button type="button" class="btn btn-outline-primary" wire:click="refrescar">
                                    ...
                                    <div class="card">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="card-body table-responsive p-0">
                                                <table
                                                    class="table table-hover responsive table-sm display text-nowrap table-striped"
                                                    id="tbOT">
                                                        ...
                                                        @foreach ($facturas as $key => $factura)
                                                            <tr>
                                                                <td class="rounded border px-4 py-2"
                                                                    ...
                                                                    <a wire:click="confirmRecepcionDetalle( {{ $factura->RecepcionCabeceraId }} )"
                                                                        title="Visualizar Detalle" style="cursor:pointer">
                                                                        <i class="fas fa-eye" style="color:#0a6ed3"
                                                                            title="Ver Detalle"></i>
                                                                    </a>
                                                                    |
                                                                    <a wire:click="confirmPrendaPersona( {{ $factura }} )"
                                                                        title="Visualizar Personas con prendas"
                                                                        style="cursor:pointer">
                                                                        <i class="fas fa-plus" style="color:#0a6ed3"
                                                                            title="Visualizar Personas con prendas"></i>
                                                                    </a>
                                                                </td>
                                                                <td class="rounded border px-4 py-2"
                                                                    style="text-align: center">
                                                                    {{ $factura->FechaRecepcion->format('d-m-Y') }}</td>
                                                                <td class="rounded border px-4 py-2"
                                                                    style="text-align: center">
                                                                    {{ $factura->NumeroDocumentoExterno }}</td>
                                                                <td class="rounded border px-4 py-2"
                                                                    style="text-align: center">
                                                                    {{ $factura->NumeroFactura }}</td>
                                                                <td class="rounded border px-4 py-2"
                                                                    style="text-align: center">
                                                                    {{ $factura->FechaDocumentoExterno->format('d-m-Y') }}
                                                                </td>
                                                                <td class="rounded border px-4 py-2"
                                                                    style="text-align: center">{{ $factura->Observacion }}
                                                                </td>
                                                                <td class="rounded border px-4 py-2"
                                                                    style="text-align: center">{{ $factura->Estado }}</td>
                                            ...
                                            <div class="col-xs-5 col-sm-5 col-md-4 col-lg-4">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input wire:model="fecha1" type="date"
                                                            class="form-control float-right" id="fecPrincipal">
                                                    </div>
                                                    <!-- /.input group -->
                                                </div>
                                            </div>
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="row" style="display: flex;
                                    ...
                                    <div class="">
                                        <div class="info-box mb-3">
                                            <span class="info-box-icon bg-warning elevation-1 text-white"
                                                style="cursor:pointer" id="finalizadaClick1"
                                    ...
                                    <div class="">
                                        <div class="info-box mb-3">
                                            <span class="info-box-icon bg-info elevation-1" style="cursor:pointer"
                                                id="CerradosClick" id="recibeBordadoClick1"
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <div class="card-tools col-6"
                                                    ...
                                                    <div class="input-group input-group-sm col-10">
                                                        <input type="text" name="table_search1"
                                                            class="form-control float-right" placeholder="Buscar"
                                                            id="buscarTabla" wire:model="search">
                                                        <div class="input-group-append">
                                                            <button type="submit" class="btn btn-default"><i
                                                                    class="fas fa-search"
                                                            ...
                                                            @foreach ($facturasCliente as $key => $factura)
                                                                <tr>
                                                                    <td class="rounded border px-4 py-2"
                                                                        ...
                                                                        |
                                                                        <a wire:click="confirmPrendaPersonaCliente( {{ $factura }} )"
                                                                            title="Visualizar Personas con prendas"
                                                                            style="cursor:pointer">
                                                                            <i class="fas fa-plus" style="color:#0a6ed3"
                                                                                title="Visualizar Personas con prendas"></i>
                                                                    ...
                                                                    <td class="rounded border px-4 py-2"
                                                                        style="text-align: center">
                                                                        {{ $factura->PedTitulo }}</td>
                                                                    <td class="rounded border px-4 py-2"
                                                                        style="text-align: center">
                                                                        {{ $factura->FechaRecepcion->format('d-m-Y') }}
                                                                    </td>
                                                                    <td class="rounded border px-4 py-2"
                                                                        style="text-align: center">{{ $factura->Estado }}
                                                                    </td>
                    ...
                    <fieldset class="form-group border p-3 scheduler-border">
                        ...
                        <div class="parent-grid-row-1">
                            ...
                            <div class="form-group">
                                ...
                                <input wire:model="todayDate" type="date" class="form-control float-right"
                                    id="fecPrincipal" name="fecPrincipal" readonly>
                            </div>
                            <!-- Pedido Asociado -->
                                ...
                                <select class="form-control" id="pedAsociado" name="pedAsociado"
                                    ...
                                    @error('pedidoAsociado')
                                        <div class="text-danger">
                                            <strong>Wow!</strong> <span
                                                id="mensajeCrudPedidoAsociado">{{ $message }}</span>
                                        </div>
                                    @enderror
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input wire:model="fechaPedidoExterno" type="date" class="form-control float-right"
                                    id="fecPedExt" name="fecPedExt" readonly>
                            </div>
                            <!-- Número Factura -->
                            <div class="form-group">
                                ...
                                @error('numeroFactura')
                                    <div class="text-danger">
                                        <strong>Wow!</strong> <span
                                            id="mensajeCrudNumeroFactura">{{ $message }}</span>
                                    </div>
                                @enderror
                            </div>
                            <!-- Observación -->
                            <div class="form-row">
                                ...
                                <textarea type="area" class="form-control" id="observacion" name="observacion" wire:model="observacionfactura"
                                    placeholder="Ingrese Observación de la factura">
                        </textarea>
                                @error('observacionfactura')
                                    <div class="text-danger">
                                        <strong>Wow!</strong> <span
                                            id="mensajeCrudObservacionfactura">{{ $message }}</span>
                                    </div>
                                @enderror
                            </div>
                            <div
                                class="form-group col-md-8 align-self-end d-flex align-items-center justify-content-center">
                                @can('Agregar modelos')
                                    <button wire:click="almacenarCabecera" type="button"
                                        class="form-control btn btn-primary"
                                        {{ $this->estadoBotonGuardarCabeceraRecepcion ? 'disabled' : 'enabled' }}>Continuar</button>
                                @endcan
                            </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-12 alert alert-danger alert-dismissible fade show text-center mt-2"
                            ...
                            <button type="button" class="close" aria-label="Close"
                                id="cerrarAlertCrudErrorPersonas10">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                    </div>
                        ...
                        <table class=" table table-hover text-nowrap">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th class="rounded border px-4 py-2" style="text-align: center">Código modelo
                                        </th>
                                        ...
                                        <th class="rounded border px-4 py-2" style="text-align: center">Cantidad
                                            Solicitada</th>
                                        <th class="rounded border px-2 py-2" style="text-align: center">Cantidad
                                            Recibida</th>
                                        <th class="rounded border px-2 py-2" style="text-align: center">Cantidad
                                            Faltante</th>
                                    </tr>
                                        ...
                                        @if ($sumatoria != null)
                                            <tr>
                                                <td class="rounded border px-4 py-2" style="text-align: center">
                                                    <a wire:click="confirmInsertarCantidad( {{ $key }} )"
                                                        title="Insertar cantidad recibida" style="cursor:pointer">
                                                        <i class="fas fa-plus" style="color:#0a6ed3"
                                                            title="Insertar cantidad recibida"></i>
                                                    </a>
                                                    @if ($sumatoria['id1'] != 'null')
                                                        <a wire:click="confirmMostrarRecepcion( {{ $sumatoria['id'] }} )"
                                                            title="Mostrar recepción anterior" style="cursor:pointer">
                                                            <i class="fas fa-eye" style="color:#0a6ed3"
                                                                title="Mostrar recepción anterior"></i>
                                                        </a>
                                                    @endif
                                                </td>
                                                <td class="rounded border px-4 py-2" style="text-align: center">
                                                ...
                                                <td class="rounded border px-4 py-2" style="text-align: center">
                                                    {{ $sumatoria['cantidadRecibida'] }}</td>
                                                <td class="rounded border px-4 py-2" style="text-align: center">
                                                    {{ $sumatoria['cantidadFaltante'] }}</td>
                                    ...
                                    @foreach ($recepcionDetalle as $key => $sumatoria)
                                        <tr>
                                            <td class="rounded border px-4 py-2" style="text-align: center">
                                                {{ $sumatoria->TipoPrenda }}</td>
                                            <td class="rounded border px-4 py-2" style="text-align: center">
                                                {{ $sumatoria->CodigoModelo }}</td>
                                            <td class="rounded border px-4 py-2" style="text-align: center">
                                                {{ $sumatoria->Talla }}</td>
                                            <td class="rounded border px-4 py-2" style="text-align: center">
                                                {{ $sumatoria->Color }}</td>
                                            <td class="rounded border px-4 py-2" style="text-align: center">
                                                {{ $sumatoria->CantidadSolicitada }}</td>
                                            <td class="rounded border px-4 py-2" style="text-align: center">
                                                {{ $sumatoria->CantidadRecibida }}</td>
                                            <td class="rounded border px-4 py-2" style="text-align: center">
                                                {{ $sumatoria->CantidadFaltante }}</td>
                    ...
                    <fieldset class="form-group border p-3 scheduler-border">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    @error('cantidadRecibida')
                                        <div class="text-danger">
                                            <strong>Wow!</strong> <span
                                                id="mensajeCrudCantidadRecibida">{{ $message }}</span>
                                        </div>
                                    @enderror
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-12 alert alert-danger alert-dismissible fade show text-center mt-2"
                                ...
                                <button type="button" class="close" aria-label="Close"
                                    id="cerrarAlertCrudErrorPersonas11">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                        </div>
                            ...
                            <table class="table table-hover text-nowrap">
                                ...
                                <tbody>
                                    @if ($listaAnterior != null)
                                        <tr>
                                            <td class="rounded border px-4 py-2" style="text-align: center">
                                                {{ $listaAnterior['tipoPrenda'] }}</td>
                                            <td class="rounded border px-4 py-2" style="text-align: center">
                                                {{ $listaAnterior['modCodigo'] }}</td>
                                            <td class="rounded border px-4 py-2" style="text-align: center">
                                                {{ $listaAnterior['tallajeTalla'] }}</td>
                                            <td class="rounded border px-4 py-2" style="text-align: center">
                                                {{ $listaAnterior['colorPrenda'] }}</td>
                                            <td class="rounded border px-4 py-2" style="text-align: center">
                                                {{ $listaAnterior['cantidadSolicitadaAnterior'] }}</td>
                                            <td class="rounded border px-4 py-2" style="text-align: center">
                                                {{ $listaAnterior['cantidadRecibidaAnterior'] }}</td>
                                            <td class="rounded border px-4 py-2" style="text-align: center">
                                                {{ $listaAnterior['cantidadFaltanteAnterior'] }}</td>
                                        </tr>
                                    @endif
                                </tbody>
                            </table>
                ...
                <x-slot name="content">
                    ...
                    <fieldset class="form-group border p-3 scheduler-border">
                        ...
                        <div class="parent-grid-row-1">
                            ...
                            <div class="form-group">
                                ...
                                <input wire:model="fechaBordado" type="date" class="form-control float-right"
                                    id="fecPrincipal" name="fecPrincipal">
                            </div>
                            <!-- Pedido Asociado -->
                            <div class="form-group" style="display: flex; flex-direction: column;">
                                <label for="pedAsociado">Pedido Externo Asociado:</label>
                                <select class="form-control" id="pedAsociado" name="pedAsociado"
                                    ...
                                    @error('pedidoAsociado')
                                        <div class="text-danger">
                                            <strong>Wow!</strong> <span
                                                id="mensajeCrudPedidoAsociadoBordado">{{ $message }}</span>
                                        </div>
                                    @enderror
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="fecPedExt">Fecha Pedido Externo Asociado:</label>
                                <input wire:model="fechaPedidoExternoBordado" type="date"
                                    class="form-control float-right" id="fecPedExt" name="fecPedExt" readonly>
                            </div>
                    </fieldset>
                    <div class="form-row">
                        <div class="col-md-12 alert alert-danger alert-dismissible fade show text-center mt-2"
                    ...
                    <div class="form-row">
                        <div class="col-md-12 alert alert-danger alert-dismissible fade show text-center mt-2"
                            ...
                            <button type="button" class="close" aria-label="Close"
                                id="cerrarAlertCrudErrorPersonas13">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                    </div>
                        ...
                        <fieldset class="form-group border p-3 scheduler-border">
                                ...
                                <div class="card-body table-responsive p-0">
                                    <table class="table table-hover text-nowrap">
                                        <thead>
                                            <tr>
                                                <th class="rounded border px-4 py-2" style="text-align: center">Tipo</th>
                                                <th class="rounded border px-4 py-2" style="text-align: center">Código
                                                    modelo</th>
                                                <th class="rounded border px-4 py-2" style="text-align: center">Talla</th>
                                                <th class="rounded border px-4 py-2" style="text-align: center">Color</th>
                                                <th class="rounded border px-4 py-2" style="text-align: center">Cantidad Solicitada</th>
                                                <th class="rounded border px-4 py-2" style="text-align: center">Cantidad Recepcionada</th>
                                                <th class="rounded border px-4 py-2" style="text-align: center">Cantidad en
                                                    Stock</th>
                                                <th class="rounded border px-4 py-2" style="text-align: center">Cantidad Faltante</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                            ...
                            <fieldset class="form-group border p-3 scheduler-border">
                                ...
                                <div class="parent-grid-row-1">
                                    ...
                                    <div class="form-group" style="display: flex; flex-direction: column;">
                                        ...
                                        <select class="form-control" id="tipo" name="tipo" wire:model="tipoBordado">
                                            ...
                                            @error('tipoBordado')
                                                <div class="text-danger">
                                                    <strong>Wow!</strong> <span
                                                        id="mensajeCrudTipoBordado">{{ $message }}</span>
                                                </div>
                                            @enderror
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group" style="display: flex; flex-direction: column;">
                                        ...
                                        <select class="form-control" id="codMod" name="codMod"
                                            ...
                                            @error('codigoModeloBordado')
                                                <div class="text-danger">
                                                    <strong>Wow!</strong> <span
                                                        id="mensajeCrudCodigoModeloBordado">{{ $message }}</span>
                                                </div>
                                            @enderror
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group" style="display: flex; flex-direction: column;">
                                        ...
                                        <select class="form-control" id="size" name="size" wire:model="tallaBordado">
                                            ...
                                            @error('tallaBordado')
                                                <div class="text-danger">
                                                    <strong>Wow!</strong> <span
                                                        id="mensajeCrudTallaBordado">{{ $message }}</span>
                                                </div>
                                            @enderror
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group" style="display: flex; flex-direction: column;">
                                        ...
                                        <select class="form-control" id="col" name="col" wire:model="colorBordado">
                                            ...
                                            @error('colorBordado')
                                                <div class="text-danger">
                                                    <strong>Wow!</strong> <span
                                                        id="mensajeCrudColorBordado">{{ $message }}</span>
                                                </div>
                                            @enderror
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group" style="display: flex; flex-direction: column;">
                                        ...
                                        <select class="form-control" id="pers" name="pers" wire:model="personaBordado">
                                            ...
                                            @error('personaBordado')
                                                <div class="text-danger">
                                                    <strong>Wow!</strong> <span
                                                        id="mensajeCrudPersonaBordado">{{ $message }}</span>
                                                </div>
                                            @enderror
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group" style="display: flex; flex-direction: row;">
                                        <div class="col-7 mr-5">
                                            ...
                                            <input type="number" min="0" max="999" class="form-control"
                                                id="cantidadPrenda" wire:model="cantidadPrendaBordado">
                                            @error('cantidadPrendaBordado')
                                                <div class="text-danger">
                                                    <strong>Wow!</strong> <span
                                                        id="mensajeCrudCantidadPrenda">{{ $message }}</span>
                                                </div>
                                            @enderror
                                        </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-12 alert alert-danger alert-dismissible fade show text-center mt-2"
                                    ...
                                    <button type="button" class="close" aria-label="Close"
                                        id="cerrarAlertCrudErrorPersonas12">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                            </div>
                            ...
                            <!-- Table row -->
                            <fieldset class="form-group border p-3 scheduler-border">
                                <legend class="w-auto px-2">Prendas Asociadas</legend>
                            <div class="row">
                                <div class="card-body table-responsive p-0">
                                    <table class="table table-hover text-nowrap">
                                        <thead>
                                            <tr>
                                                <th class="rounded border px-4 py-2" style="text-align: center"
                                                    style="font-weight:bold;">Acción</th>
                                                <th class="rounded border px-4 py-2" style="text-align: center"
                                                    style="font-weight:bold;">Tipo</th>
                                                <th class="rounded border px-4 py-2" style="text-align: center"
                                                    style="font-weight:bold;">Código modelo</th>
                                                <th class="rounded border px-4 py-2" style="text-align: center"
                                                    style="font-weight:bold;">Talla</th>
                                                <th class="rounded border px-4 py-2" style="text-align: center"
                                                    style="font-weight:bold;">Color</th>
                                                <th class="rounded border px-4 py-2" style="text-align: center"
                                                    style="font-weight:bold;">Cantidad</th>
                                                <th class="rounded border px-4 py-2" style="text-align: center"
                                                    style="font-weight:bold;">Persona</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach ($listaBordado as $key => $list)
                                                @if ($sumatoria != null)
                                                    <tr>
                                                        <td class="rounded border px-4 py-2" style="text-align: center">
                                                            <a wire:click="quitarPrendaBordado( {{ $key }} )"
                                                                title="Quitar relacion prenda persona"
                                                                style="cursor:pointer">
                                                        ...
                                                        <td class="rounded border px-4 py-2" style="text-align: center">
                                                            {{ $list['tipoBordado'] }}</td>
                                                        <td class="rounded border px-4 py-2" style="text-align: center">
                                                            {{ $list['codigoModeloBordado'] }}</td>
                                                        <td class="rounded border px-4 py-2" style="text-align: center">
                                                            {{ $list['tallaBordado'] }}</td>
                                                        <td class="rounded border px-4 py-2" style="text-align: center">
                                                            {{ $list['colorBordado'] }}</td>
                                                        <td class="rounded border px-4 py-2" style="text-align: center">
                                                            {{ $list['cantidadPrendaBordado'] }}</td>
                                                        <td class="rounded border px-4 py-2" style="text-align: center">
                                                            {{ $list['personaBordado'] }}</td>
                                ...
                                <table class="table table-hover text-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="rounded border px-2 py-2" style="text-align: center">Persona
                                                Asociada</th>
                                            <th class="rounded border px-2 py-2" style="text-align: center">Estado</th>
                                            <th class="rounded border px-2 py-2" style="text-align: center">Fecha
                                                Asignación</th>
                                            <th class="rounded border px-2 py-2" style="text-align: center">Fecha
                                                Bordado</th>
                                            <th class="rounded border px-2 py-2" style="text-align: center">Fecha
                                                Recibe de Bordado</th>
                                            <th class="rounded border px-2 py-2" style="text-align: center">Fecha
                                                Entregado</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($prendaPersona as $key => $list)
                                            <tr>
                                                <td class="rounded border px-4 py-2" style="text-align: center">
                                                    <a wire:click="confirmEstadoPrendaPersona( {{ $list->prendaPersonaId }} )"
                                                        title="Editar estado" style="cursor:pointer">
                                                        <i class="fas fa-edit" style="color:#0a6ed3"></i>
                                                    </a>
                                                </td>
                                                <td class="rounded border px-4 py-2" style="text-align: center">
                                                    {{ $list->TipoPrendaPersona }}</td>
                                                <td class="rounded border px-4 py-2" style="text-align: center">
                                                    {{ $list->CodigoModeloPersona }}</td>
                                                <td class="rounded border px-4 py-2" style="text-align: center">
                                                    {{ $list->TallaPersona }}</td>
                                                <td class="rounded border px-4 py-2" style="text-align: center">
                                                    {{ $list->ColorPersona }}</td>
                                                <td class="rounded border px-4 py-2" style="text-align: center">
                                                    {{ $list->CantidadPersona }}</td>
                                                <td class="rounded border px-4 py-2" style="text-align: center">
                                                    {{ $list->PersonaAsociada }}</td>
                                                <td class="rounded border px-4 py-2" style="text-align: center">
                                                        {{ $list->EstadoPersona }}                                   
                                                </td>
                                                <td class="rounded border px-4 py-2" style="text-align: center">
                                                    @if($list->FechaAsignado != null)
                                                    {{ date('d-m-Y', strtotime($list->FechaAsignado)) }}</td>
                                                    @endif
                                                <td class="rounded border px-4 py-2" style="text-align: center">
                                                    @if($list->FechaBordado != null)
                                                    {{ date('d-m-Y', strtotime($list->FechaBordado)) }}</td>
                                                    @endif
                                                <td class="rounded border px-4 py-2" style="text-align: center">
                                                    @if($list->FechaRecibeBordado != null)
                                                    {{ date('d-m-Y', strtotime($list->FechaRecibeBordado)) }}</td>
                                                    @endif
                                                <td class="rounded border px-4 py-2" style="text-align: center">
                                                    @if($list->FechaEntregado != null)
                                                    {{ date('d-m-Y', strtotime($list->FechaEntregado)) }}</td>
                                                    @endif    
                                            </tr>
                                        @endforeach
                                    </tbody>
                        ...
                        <div class="form-row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="est" wire:model="estadoPrendaPersona">
                                        <option value="none" selected hidden>Seleccione</option>
                                    ...
                                    @error('estadoPrendaPersona')
                                        <div class="text-danger">
                                            <strong>Wow!</strong> <span
                                                id="mensajeCrudEstadoPrendaPersona">{{ $message }}</span>
                                        </div>
                                    @enderror
                                </div>
                            </div>
