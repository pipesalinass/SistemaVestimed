                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="rounded border px-4 py-2" style="text-align: center">
                                            ...
                                            @endcan
                                            @endif
                                            @if ($pedido->PedEstado == 'GENERADO' || $pedido->PedEstado == 'EN TALLAJE' || $pedido->PedEstado == 'GESTION DE PEDIDO'|| $pedido->PedEstado == 'ESPERA DE PRENDAS')
                                            ...
                                            @endcan
                                            @endif
                                            @if ($pedido->PedEstado == 'GESTION DE PEDIDO'|| $pedido->PedEstado == 'ESPERA DE PRENDAS')
                                            @can('Realizar Tallajes')   
                                            |       
